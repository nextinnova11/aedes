      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/senarai-tindakan-admin')}}">Senarai Jadual Tindakan</a></li>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $table->nama }}</td>
                        <?php $table1 = DB::table('users')->where('id', $value->pegawaiVektor_id)->first();?>
                        <td>{{ $table1->name }}</td>
                        <td><a href="mailto:$value->email">{{ $table1->email }}</a></td>
