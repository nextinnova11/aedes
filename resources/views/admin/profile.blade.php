      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('profil', $value = Auth::user()->id) }}">Profil Pengguna</a></li>
            ...
            <div class="col-md-9">
              <div class="nav-tabs-custom">
                ...
                <div class="active tab-pane" id="activity">
                    <form class="form-horizontal" method="PUT" action= "{{ URL('kemaskini-profile', $pengguna1->id) }}">
                        <div class="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->no_tel}}" name="jawatan" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Nombor Rumah</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->alamat_1}}" name="no_rumah" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Taman Rumah</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->alamat_2}}" name="taman_rumah" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Jalan Rumah</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->alamat_3}}" name="jalan_rumah" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Poskod</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->poskod}}" name="poskod" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Bandar</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->bandar}}" name="bandar" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Negeri</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->negeri}}" name="negeri" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSkills" class="col-sm-2 control-label">Nombor Pekerja</label>
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$pengguna2->no_pekerja}}" name="no_pekerja" class="form-control" id="inputSkills">
                                </div>
                            </div>
                      </div>
                </div>
