              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  ...
                  @if (count($errors) > 0)
                    ...
                    @endforeach
                  @endif
                  <form class="form-horizontal" method="PUT" action= "{{ URL('kemaskini-kalendar-baru', $jadual1->id) }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="form-horizontal" >
                          <div class="form-group">
                              <label for="inputName" class="col-sm-2 control-label">Pembanci</label>
                              <div class="col-sm-10">
                                <input type="text" readonly value="{{$usercalendar->name}}" name="pembanci" class="form-control" id="inputSkills">
                              </div>
                          </div>
                          <div class="form-group">
                              <label for="inputName" class="col-sm-2 control-label">Kawasan Bancian</label>
                              <div class="col-sm-10">
                                <input type="text" readonly value="{{$kawasancalendar->nama}}" name="kawasan" class="form-control" id="inputSkills">
                              </div>
                          </div>
                          <div class="form-group">
                              <label for="inputName" class="col-sm-2 control-label">Tarikh Mula</label>
                              <div class="col-sm-10">
                                  <input type="date" name="mula" class="form-control" id="inputName">
                              </div>
                          </div>
                          <div class="form-group">
                              <label for="inputExperience" class="col-sm-2 control-label">Tarikh Tamat</label>
                              <div class="col-sm-10">
                                  <input type="date" name="akhir" class="form-control" id="inputSkills">
                              </div>
                          </div>
                          <div class="form-group">
