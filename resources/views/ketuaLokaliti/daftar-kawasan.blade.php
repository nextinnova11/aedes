...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
          <i class="fa fa-edit"></i> Daftar Kawasan
      </h1>
      <ol class="breadcrumb">
            <li><a href="{{ url('/ketuaLokaliti') }}"><i class="fa fa-dashboard"></i> Utama</a></li>
            <li><a href="{{ url('/daftar-kawasan') }}">Daftar Kawasan</a></li>
            <li class="active">Pendaftaran Kawasan</li>
      </ol>
    </section>
            ...
            <div class="container">
              <div class="col-sm-11">
                ...
                @if (count($errors) > 0)
                  ...
                  @endforeach
                @endif
                <form method="PUT" action= "{{ URL('daftar-kawasan-kl') }}">
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      ...
                      <select class="form-control m-bot15" name="nama_perumahan" id="nama_perumahan">
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Nama Kawsan:</label>
                      <input type="text" class="form-control my-colorpicker1" name="name" id="name" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Bandar:</label>
                      <input type="text" class="form-control my-colorpicker1" name="city" id="locality" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Negeri:</label>
                      <input type="text" class="form-control my-colorpicker1" name="state" id="administrative_area_level_1" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Pembanci:</label>
                            ...
                            <select class="form-control m-bot15" name="pembanci" id="pembanci" required>
                              @foreach($pembanci as $key => $value)
                              <?php $table = DB::table('kawasans')->where('user_id', $value->id)->first();
                                  if ($table == null) { ?>
