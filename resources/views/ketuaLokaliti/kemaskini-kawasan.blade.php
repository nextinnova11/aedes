            ...
            <div class="container">
              <div class="col-sm-11">
                ...
                @if (count($errors) > 0)
                  ...
                  @endforeach
                @endif
                <form method="PUT" action= "{{ URL('kemaskini-kawasan-baru', $kawasan1->id) }}">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Nama Perumahan:</label>
                      <input type="text" readonly value="{{$perumahankemaskini->nama}}" class="form-control my-colorpicker1" name="perumahan" id="perumahan">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-6">
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      ...
                      <input type="text" readonly value="{{$userkemaskini->name}}" class="form-control my-colorpicker1" name="pembanci" id="pembanci">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class=" col-sm-10">
