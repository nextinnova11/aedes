...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/daftar-baru-pembanci', $value = Auth::user()->i) }}">Daftar Pengguna</a></li>
            <li class="active">Daftar Pembanci</li>
      </ol>
    </section>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Daftar Baru Pembanci</div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('/daftar-pembanci') }}">
                                      {!! csrf_field() !!}
                                      ...
                                      <div class="form-group{{ $errors->has('namaJalan') ? ' has-error' : '' }}">
                                          <label class="col-md-4 control-label">Nama Jalan</label>
                                          <div class="col-md-6">
                                      ...
                                      <div class="form-group{{ $errors->has('negeri') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-md-6">
                                            <select class="form-control m-bot15" name="negeri" value="{{ old('negeri') }}" id="negeri">
                                                ...
                                                <option> Melaka Darul Azim </option>
