      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('kemaskini-profile-kl', $value = Auth::user()->id) }}">Kemaskini Profil</a></li>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="active tab-pane" id="activity">
                  ...
                  @if (count($errors) > 0)
                    ...
                    <form class="form-horizontal" method="PUT" action= "{{ URL('kemaskiniprofilkl', $pengguna1->id) }}">
