@include('sider-ketua-lokaliti')
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Semak Kawasan
            <small>Senarai Kawasan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="{{(url('/ketuaLokaliti'))}}"><i class="fa fa-dashboard"></i> Utama</a></li>
            <li><a href="{{ url('/senarai-kawasan')}}">Semak Kawasan</a></li>
            <li class="active">Senarai Kawasan</li>
          </ol>
        </section>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $counter }}</td>
                        <?php $perumahan = DB::table('perumahans')->where('id', $value->perumahan_id)->first() ?>
                        ...
                        <td> {{ $user->name }}</td>
                        <td>
                              <a class="btn btn-app" method="DELETE" href="{{ URL('kemaskini-kawasan', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin kemaskini kawasan ini?')"><i class="fa fa-pencil"></i>Kemaskini</a>
                              <a class="btn btn-app" method="DELETE" href="{{ URL('hapus-kawasan', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin membuang kawasan ini?')"><i class="fa fa-remove"></i>Hapus</a>
                        </td>
                      </tr>
                      <?php
                          $counter++;
