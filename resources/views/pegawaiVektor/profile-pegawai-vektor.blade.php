      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('profil-pegawai-vektor', $value = Auth::user()->id) }}">Profil Pengguna</a></li>
                    ...
                    <form class="form-horizontal" method="PUT" action= "{{ URL('kemaskinialamat', $pengguna1->id) }}">
                        <div class="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" readonly value="{{$value->no_pekerja}}" name="jawatan" class="form-control" id="inputSkills">
                                </div>
                            </div>
                            @endforeach
                      </div>
