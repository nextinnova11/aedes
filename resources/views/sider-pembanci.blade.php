...
<html>
  <head>
    ...
    <title>Pembanci : Sistem Amaran Awal Aedes</title>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      {{ Auth::user()->name}}
                      <small>Pembanci : {{ Auth::user()->created_at}}</small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ url('profil-pembanci', $value = Auth::user()->id) }}" class="btn btn-default btn-flat">Profil</a>
                    </div>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="{{ URL('senarai-bancian-pembanci')}}">
                <i class="fa fa-calendar"></i>
                <span>Jadual Bancian</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('profil-pembanci', $value = Auth::user()->id) }}"><i class="fa fa-tv"></i> Papar Maklumat</a></li>
                <li><a href="{{ url('kemaskini-profile-pembanci', $value = Auth::user()->id) }}"><i class="fa fa-pencil"></i> Kemaskini Maklumat</a></li>
                <li><a href="{{ url('ubah-kata-laluan-pembanci', $value = Auth::user()->id) }}"><i class="fa fa-wrench"></i> Ubah Kata Laluan</a></li>
              </ul>
            </li>
          </ul>
        </section>
