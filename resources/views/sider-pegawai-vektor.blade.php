...
<html>
  <head>
    ...
    <title>Pegawai Vektor : Sistem Amaran Awal Aedes</title>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      {{ Auth::user()->name}}
                      <small>Pegawai Vektor : {{ Auth::user()->created_at}}</small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ url('profil-pegawai-vektor', $value = Auth::user()->id) }}" class="btn btn-default btn-flat">Profil</a>
                    </div>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="{{ URL('senarai-tindakan-pv')}}">
                <i class="fa fa-calendar-plus-o"></i>
                <span>Jadual Tindakan</span>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('profil-pegawai-vektor', $value = Auth::user()->id) }}"><i class="fa fa-tv"></i> Papar Maklumat</a></li>
                <li><a href="{{ url('kemaskini-profile-pv', $value = Auth::user()->id) }}"><i class="fa fa-pencil"></i> Kemaskini Maklumat</a></li>
                <li><a href="{{ url('ubah-kata-laluan-PV', $value = Auth::user()->id) }}"><i class="fa fa-wrench"></i> Ubah Kata Laluan</a></li>
              </ul>
            </li>
          </ul>
        </section>
