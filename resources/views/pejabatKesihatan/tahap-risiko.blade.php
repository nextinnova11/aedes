      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{(url('/tahap-risiko'))}}">Daftar Tahap Risiko</a></li>
          ...
          <div class="row">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align:center;">
                            <a class="btn btn-app" method="DELETE" href="{{ URL('kemaskini-tahap-risiko', $value->id) }}" title="kemaskini" onclick="return confirm('Adakah anda ingin mengemaskini risiko ini?')"><i class="fa fa-pencil-square-o"></i>Kemaskini</a>
                          </td>
                        </tr>
                        <?php
                            $counter++;
            ...
            <div class="col-md-6">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <form class="form-horizontal" role="form" method="POST" action="{{ URL('/daftar-risiko') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group{{ $errors->has('tahap') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="tahap" value="{{ old('tahap') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('warna') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                              <select class="form-control m-bot15" name="warna" value="{{ old('warna') }}" id="negeri" >
                                  <option> Hijau </option>
                                  <option> Oren </option>
                                  <option> Merah </option>
                                  <option> Biru </option>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-plus"></i> Daftar
                                </button>
                            </div>
                        </div>
                      </form>
