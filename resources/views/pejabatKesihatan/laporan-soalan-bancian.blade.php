                ...
                <div class="box-header">
                  ...
                  <?php if($table1->status == "Aktiviti Semburan Selesai") {?>
                      <div class="alert alert-danger alert-dismissable">
                        ...
                        {{$kawasan}} sangat berisiko di dalam proses pembiakan nyamuk Aedes pada tarikh {{$tahun}}.
                      </div>
                  <?php } ?>
                  <?php if($table1->status == "Selesai") {?>
                      <div class="alert alert-success alert-dismissable">
                        ...
                        {{$kawasan}} bebas daripada pembiakan nyamuk Aedes pada tarikh {{$tahun}}.
                      </div>
                  <?php } ?>
                  ...
                  <?php if($table1->status == "Aktiviti Penyemburan Diperlukan") {?>
                      <div class="alert alert-warning alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <h4><i class="icon fa fa-warning"></i> Aktiviti Penyemburan Sedang Dilakukan </h4>
