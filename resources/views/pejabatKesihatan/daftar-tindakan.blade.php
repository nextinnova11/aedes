...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
          <i class="fa fa-edit"></i> Daftar Jadual Tindakan
      </h1>
      <ol class="breadcrumb">
            <li><a href="{{ url('/pejabatKesihatan') }}"><i class="fa fa-dashboard"></i> Utama</a></li>
            <li>Daftar Tindakan</li>
            <li class="active">Pendaftaran Jadual Tindakan</li>
      </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="container">
              <div class="col-sm-11">
                <div class="form-group">
                  @if (count($errors) > 0)
                    ...
                    @endforeach
                  @endif
                  <form method="POST" action= "{{ URL('daftar-kawalan') }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="input-group">
                    <div class="input-group-addon">
                      <i class="fa fa-search"></i>
                    </div>
                    <input type="text" class="form-control" id="nama_taman" name="nama_taman" value="{{ $kwsndftrkawalan->nama }}" readonly>
                  </div>
                  <div id="map-canvas"></div>
                </div>
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Pegawai Vektor:</label>
                      <select class="form-control m-bot15" name="pegawai_vektor" id="pegawai_vektor" required>
                        @foreach($pegawaivektor as $key => $value)

                        <?php $table = DB::table('jadual_tindakans')->where('pegawaiVektor_id', $value->name)->first();
                            if ($table == null) { ?>
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label for="inputName" class="col-xs-6 control-label">Tarikh Tindakan</label>
                          <input type="date" name="tindakan" class="form-control" id="inputName" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-xs-6">
                      <label>Nota:</label>
                      <textarea class="form-control my-colorpicker1" name="nota" cols="30" rows="5" required></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class=" col-sm-12">
              ...
              function initialize() {
                ...
                // var input = (document.getElementById('nama_taman'));
