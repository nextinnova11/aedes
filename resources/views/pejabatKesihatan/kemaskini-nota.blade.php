      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{(url('/kemaskini-senarai-nota', $notasenarai->id))}}">Kemaskini Mesej</a></li>
          ...
          <div class="row">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align:center;">
                            <a class="btn btn-app" method="DELETE" href="{{ URL('kemaskini-senarai-nota', $value->id) }}" title="Kemaskini" onclick="return confirm('Adakah anda ingin mengemaskini pengguna ini?')"><i class="fa fa-pencil"></i>Kemaskini</a>
                            <a class="btn btn-app" method="DELETE" href="{{ URL('hapus-nota', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin membuang pengguna ini?')"><i class="fa fa-remove"></i>Hapus</a>
                        </tr>
                        <?php
                            $counter++;
                        ?>
            ...
            <div class="col-md-6">
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <form class="form-horizontal" role="form" method="PUT" action="{{ URL('/kemaskini-nota', $notasenarai->id) }}">
                        {!! csrf_field() !!}
