...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/daftar-baru-KL', $value = Auth::user()->i) }}">Daftar Pengguna</a></li>
            <li class="active">Ketua Lokaliti</li>
      </ol>
    </section>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Daftar Baru Ketua Lokaliti</div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('/daftar-ketua-lokaliti') }}">
                                      {!! csrf_field() !!}
