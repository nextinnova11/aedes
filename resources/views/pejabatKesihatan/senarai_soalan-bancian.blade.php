      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/senarai-soalan-bancian')}}">Semak Soalan Bancian</a></li>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center;">
                          <a class="btn btn-app" method="DELETE" href="{{ URL('kemaskini-soalan', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin mengemaskini soalan ini?')"><i class="fa fa-pencil-square-o"></i>Kemaskini</a>
                        </td>
                      </tr>
                      <?php
                          $counter++;
