...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/daftar-baru-PV', $value = Auth::user()->i) }}">Daftar Pengguna</a></li>
            <li class="active">Pegawai Vektor</li>
      </ol>
    </section>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Daftar Baru Pegawai Vektor</div>
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('/daftar-pegawai-vektor') }}">
                                      {!! csrf_field() !!}
