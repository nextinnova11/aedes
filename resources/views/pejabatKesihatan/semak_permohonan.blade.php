      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/semak-permohonan-PK')}}">Semak Permohonan</a></li>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <!-- <i class="btn btn-app"> -->
                              <a class="btn btn-app" method="DELETE" href="{{ URL('hapus-pengguna', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin membuang pengguna ini?')"><i class="fa fa-remove"></i>Hapus</a>
                          <!-- </i> -->
                        </td>
                      </tr>
                      <?php
