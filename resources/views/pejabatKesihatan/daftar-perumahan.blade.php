            ...
            <div class="container">
              <div class="col-sm-11">
                ...
                @if (count($errors) > 0)
                  ...
                  @endforeach
                @endif
                <form method="PUT" action= "{{ URL('daftar-perumahan-pk') }}">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">

                  <input type="hidden" name="_lat" id="lat" value="">
                  <input type="hidden" name="_lng" id="lng" value="">
                  ...
                  <div class="form-group">
                    <div class="col-xs-6">
                      ...
                      <select class="form-control m-bot15" name="ketua_lokaliti" id="ketua_lokaliti" required>
                        @foreach($ketualokaliti as $key => $value)

                        <?php $table = DB::table('perumahans')->where('ketualokaliti_id', $value->id)->first();
                            if ($table == null) { ?>
