@include('sider-pejabat-kesihatan')
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Semak Perumahan
            <small>Senarai Perumahan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="{{(url('/pejabatKesihatan'))}}"><i class="fa fa-dashboard"></i> Utama</a></li>
            <li><a href="{{ url('/senarai-perumahan')}}">Semak Perumahan</a></li>
            <li class="active">Senarai Perumahan</li>
          </ol>
        </section>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $value->bandar }}</td>
                        <td> {{ $value->negeri }}</td>
                        <?php $table = DB::table('users')->where('id', $value->ketualokaliti_id)->first();?>
                        <td> {{ $table->name }}</td>
                        <td>
                              <a class="btn btn-app" method="DELETE" href="{{ URL('kemaskini-perumahan', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin kemaskini perumahan ini?')"><i class="fa fa-pencil"></i>Kemaskini</a>
                              <a class="btn btn-app" method="DELETE" href="{{ URL('hapus-perumahan', $value->id) }}" title="Hapus" onclick="return confirm('Adakah anda ingin membuang perumahan ini?')"><i class="fa fa-remove"></i>Hapus</a>
                        </td>
                      </tr>
                      <?php
                          $counter++;
