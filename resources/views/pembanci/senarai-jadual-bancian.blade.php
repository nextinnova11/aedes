      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/senarai-bancian-pembanci')}}">Senarai Jadual Bancian</a></li>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $counter }}</td>
                        <td>{{ $namapembanci->name }}</td>
                        <td>{{ $kawasanbancian->nama }}</td>
                        ...
                        <td>
                              ...
                              <a class="btn btn-app" method="DELETE" href="{{ URL('bancian', $value->id) }}" title="Bancian" onclick="return confirm('Adakah anda ingin membuat bancian sekarang?')"><i class="fa fa-file-archive-o"></i>Bancian</a>
                              <a class="btn btn-app" method="DELETE" href="{{ URL('kemaskini-bancian', $value->id) }}" title="Bancian" onclick="return confirm('Adakah anda pasti semua unit rumah telah selesai dibuat bancian?')"><i class="fa fa-repeat"></i>Bancian Selesai</a>
                              <?php } ?>
                              <?php } else if($value->tarikh_akhir == $second) { ?>
                                Tarikh bancian telah berakhir
                                <?php } else { ?>
                                  Anda masih belum boleh melakukan bancian
                                <?php } ?>
                        </td>
                      </tr>
                      <?php
