      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('ubah-kata-laluan-pembanci', $value = Auth::user()->id) }}">Ubah Kata Laluan</a></li>
            ...
            <div class="col-md-9">
              <div class="nav-tabs-custom">
                ...
                <div class="active tab-pane" id="activity">
                    <form class="form-horizontal" method="PUT" action= "{{ URL('katalaluan-pembanci', $pengguna1->id) }}">
