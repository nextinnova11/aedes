      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('kemaskini-profile-pembanci', $value = Auth::user()->id) }}">Kemaskini Profil</a></li>
            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <p class="text-muted text-center">Pembanci</p>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="active tab-pane" id="activity">
                  ...
                  @if (count($errors) > 0)
                    ...
                    <form class="form-horizontal" method="PUT" action= "{{ URL('kemaskiniprofilpembanci', $pengguna1->id) }}">
